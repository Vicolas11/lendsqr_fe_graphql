function generateRandomUserArray(numObjects) {
    var organizations = ["Lendsqr", "Lendstar", "Irorun"];
    var statuses = ["Active", "Inactive", "Pending", "Blacklisted"];
    var genders = ["Male", "Female"];
    var maritalStatuses = ["Single", "Married", "Divorced", "Widowed"];
    var typesOfResidence = [
        "Parent's Apartment",
        "Rented Apartment",
        "Self-Owned",
    ];
    ...
    for (var i = 0; i < numObjects; i++) {
        var user = {
            ...
            profile: {
                ...
                lendsqrId: "LSQFf587g".concat(getRandomNumber(100, 999)),
            ...
            socials: {
                facebook: "@".concat(getRandomUsername()),
                instagram: "@".concat(getRandomUsername()),
                twitter: "@".concat(getRandomUsername()),
            },
            education: {
                ...
                duration: "".concat(getRandomNumber(1, 20), " years"),
...
function getRandomUsername() {
    return (getRandomName().substring(0, 3) +
        getRandomName().substring(0, 3) +
        getRandomNumber(1, 100));
}
function getRandomEmail() {
    var domains = ["gmail.com", "yahoo.com", "hotmail.com", "outlook.com"];
    return "".concat(getRandomUsername().toLowerCase(), "@").concat(getRandomFromArray(domains));
}
function getRandomPhoneNumber() {
    var prefixes = ["070", "080", "090", "081"];
    var randomPrefix = getRandomFromArray(prefixes);
    var randomNumber = Math.floor(Math.random() * 1000000000)
        .toString()
        .padStart(9, "0");
    return "".concat(randomPrefix).concat(randomNumber);
}
function getRandomAccountNumber() {
    return "027809".concat(getRandomNumber(1000, 9999));
}
function getRandomBVN() {
    var prefix = "222";
...
function getRandomDate() {
    var year = getRandomNumber(2000, 2024);
    var month = getRandomNumber(1, 12).toString().padStart(2, "0");
    var day = getRandomNumber(1, 28).toString().padStart(2, "0");
    return "".concat(year, "-").concat(month, "-").concat(day, "T03:44:22.522Z");
}
// Usage example:
var randomUsers = generateRandomUserArray(453);

import { writeFile } from "fs";

const content = JSON.stringify(randomUsers, null, 2);
